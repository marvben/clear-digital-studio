    ...
    <>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_1fr]">
            <div>
              ...
              <p className="mt-8 max-w-[420px] text-[15px] leading-[1.7] text-white/55">
                We build fast, search-optimized websites for service businesses
                across Canada. Fixed pricing, no contracts, live in under two weeks.
              </p>

              <div className="mt-10 flex items-center gap-4">
                <Button
                  asChild
                  className="h-11 rounded-xl bg-white px-5 text-[13px] font-semibold text-ink hover:bg-white/90"
                >
                  <Link href="/contact">
                    Start a project
                ...
                <Link
                  href="/portfolio"
                  className="text-[13px] font-medium text-white/60 transition-colors hover:text-white/80"
                >
                  See our work
                </Link>
              </div>
        ...
        <div className="grid items-start gap-20 lg:grid-cols-[1fr_380px]">
          <div className="reveal">
            ...
            <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-gray-400">
              Slow load times, no Google visibility, broken on phones. If your
              site isn&apos;t actively bringing in leads, it&apos;s a liability.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="reveal flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-3 max-w-md font-display text-[clamp(28px,3.5vw,42px)] font-semibold leading-[1.15] tracking-tight text-ink">
                Design, build, rank, maintain.
              </h2>
            </div>
            <Link
              href="/services"
              className="inline-flex items-center gap-1.5 text-[13px] font-medium text-gray-400 transition-colors hover:text-ink"
            >
          ...
          <div className="mt-14 grid gap-px overflow-hidden rounded-2xl border border-gray-200/70 bg-gray-200/50 sm:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              <div
                key={s.title}
                className={`reveal reveal-delay-${Math.min(i + 1, 5)} bg-white p-6 lg:p-7`}
              >
      ...
      <Section className="bg-white">
        <div className="reveal">
          ...
          <div className="mt-3 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <h2 className="max-w-sm font-display text-[clamp(28px,3.5vw,42px)] font-semibold leading-[1.15] tracking-tight text-ink">
          ...
          {portfolioItems.map((item, i) => (
            ...
            >
              ...
              <div className="mt-4">
                ...
                <h3 className="mt-1 font-heading text-[15px] font-semibold text-ink">
                  {item.title}
                </h3>
                <p
          ...
          <div className="reveal grid items-center gap-16 lg:grid-cols-[1fr_1.1fr]">
            <div>
              ...
              <blockquote className="mt-6 font-display text-[clamp(22px,2.8vw,32px)] font-medium leading-[1.35] tracking-tight text-ink">
                &ldquo;We went from barely getting any online inquiries to 5-6
                calls a week. The website paid for itself in the first month.&rdquo;
              </blockquote>
            ...
            <div className="space-y-4">
              {[
                {
                  quote:
                    "They actually listened instead of just selling us stuff. Bookings are up 3x.",
                  name: "Lisa Park",
                  role: "Gloss Beauty Studio, Calgary",
                },
                {
                  quote:
                    "Had the site live in 9 days. Made the whole process painless.",
                  name: "Carlos Rivera",
      ...
      <Section className="bg-white">
        <div className="reveal">
          ...
          <h2 className="mt-3 max-w-sm font-display text-[clamp(28px,3.5vw,42px)] font-semibold leading-[1.15] tracking-tight text-ink">
            Idea to live site in four steps.
          </h2>
        </div>
        ...
        <div className="mt-14 grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={step.n} className={`reveal reveal-delay-${i + 1}`}>
              <span className="font-heading text-4xl font-bold text-gray-100">
                {step.n}
              </span>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="reveal mx-auto max-w-xl text-center">
            ...
            <p className="mt-5 text-[15px] leading-relaxed text-white/55">
              Free 30-minute call. We&apos;ll look at what you have, tell you
              what&apos;s possible, and be honest about whether we&apos;re the right fit.
            </p>
